---
title: Human Attention is All You Need
number: 23
author: Luis Chaves Rodriguez
author_link: https://www.linkedin.com/in/lucha6
retreat: 2
---
...
## <a id="looking-for-clues-in-language-society"></a>Looking for clues in Language & Society
...
### <a id="attention-in-language"></a>Attention in Language
...
### <a id="attention-in-society"></a>Attention in Society

#### <a id="the-attention-economy-big-tech-advertising"></a>The Attention Economy, Big Tech & Advertising
...
#### <a id="the-highway-to-our-attention-are-our-emotions"></a>The highway to our attention are our emotions
...
#### <a id="the-attachment-economy-the-future-of-attention-and-technology"></a>The Attachment Economy, the future of attention and technology
...
## <a id="from-intuitions-to-a-map"></a>From intuitions to a map
...
### <a id="a-rough-model-of-inputs-outputs-what-affects-attention-and-what-is-attention-able-to-affect"></a>A rough model of inputs & outputs, what affects attention and what is attention able to affect?

#### <a id="what-captures-attention"></a>What captures attention?
...
<img class="imagecenter" src="assets/23-attention-flow.png" alt="Sensing leads to attention leads to action">
...
<img class="imagecenter" src="assets/23-recursive-attention.png" alt="attention pays attention to attention">

*A second, top-down attention (attention₂) watches the bottom-up sensing → attention₁ → action loop.*

#### <a id="top-down-bottom-up-attention-and-the-two-guards"></a>Top-down & Bottom-up attention and the Two Guards
...
#### <a id="what-makes-a-signal-break-through-the-attention-gate"></a>What makes a signal break through the attention gate?
...
#### <a id="things-that-attention-can-have-an-effect-on"></a>Things that attention can have an effect on
...
##### <a id="memory-learning-discovery"></a>Memory, Learning  & Discovery
...
##### <a id="social-connection-self-connection-and-attachment-styles"></a>Social connection, self-connection and attachment styles
...
### <a id="finding-clarity-a-map-of-the-brain-the-human-body-and-the-environment"></a>Finding clarity, a map of the brain, the human body and the environment
...
#### <a id="adhd-attention-interventions-the-brains-complexity"></a>ADHD, attention interventions & the brain's complexity
...
#### <a id="the-map-example-interventions"></a>The map & example interventions
...
<img class="imagecenter" src="assets/23-systems-map.png" alt="A vertical stack from senses up to environment, with bottom-up and top-down flows">
...
<img class="imagecenter" src="assets/23-interventions.png" alt="Three attention interventions traced across the layer stack">
...
#### <a id="system-of-systems-plasticity-and-flux"></a>System of Systems, Plasticity and Flux
...
##### <a id="metacognition-does-it-escape-the-loop"></a>Metacognition, does it escape the loop?
...
#### <a id="philosophical-implications-who-are-you-but-the-universe"></a>Philosophical implications, who are you but the universe?
...
### <a id="hope-for-change-open-questions"></a>Hope for change & open questions
...
## <a id="closing-remarks"></a>Closing remarks
...
## <a id="attention-in-language-2"></a>Attention in Language
...
## <a id="attention-the-economy"></a>Attention & the economy

### <a id="fear-and-capital-allocation"></a>Fear and capital allocation
...
## <a id="attention-the-brain"></a>Attention & the brain
...
### <a id="consciousness-at-the-sub-molecular-level"></a>Consciousness at the sub-molecular level
...
### <a id="the-different-levels"></a>The different levels
...
### <a id="autonomous-attention-capture-the-map"></a>Autonomous attention capture & the map
...
## <a id="recommended-reading"></a>Recommended reading
...
# <a id="notes-references"></a>Notes & References
